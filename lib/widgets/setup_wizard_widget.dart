          ...
          child: Container(
            ...
            child: Row(
              children: [
                ...
                Expanded(child: RichText(text: const TextSpan(style: TextStyle(color: Colors.blue, fontSize: 13, height: 1.4), children: [TextSpan(text: 'These subjects are GLOBAL.\n', style: TextStyle(fontWeight: FontWeight.bold)), TextSpan(text: 'They apply automatically to every Term.')]))),
              ],
            ),
          ),
        ),
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      if (sub.components.isEmpty) ...[
                        ...
                        const SizedBox(height: 8),
                        const Text('Components (Theory, Practical, etc.)', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 12)),
                        const Text('Hint: Passing marks = 0 means component is ignored.', style: TextStyle(fontSize: 11, color: Colors.grey)),
                        const SizedBox(height: 8),
