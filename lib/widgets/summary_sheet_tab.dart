      ...
      children: [
        Padding(
          ...
          child: Column(
            ...
            children: [
              const Text("Overview", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16, color: Color(0xFF00897B))),
          ...
          child: Container(
            ...
            child: SingleChildScrollView(
              ...
              child: SingleChildScrollView(
                ...
                child: DataTable(
                  columnSpacing: 20, 
                  // FIX: Explicitly forcing gridlines to show
