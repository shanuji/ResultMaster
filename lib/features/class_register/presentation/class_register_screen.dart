  ...
  Widget build(BuildContext context) => AnimatedBuilder(
        ...
        builder: (context, _) => Scaffold(
          appBar: AppBar(title: const Text('Class Registers'), actions: [
            ...
            IconButton(onPressed: controller.selected == null ? null : () => ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('Use ExcelRegisterCodec to import .xlsx files.'))), icon: const Icon(Icons.upload_file), tooltip: 'Import Excel'),
